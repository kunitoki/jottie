...
static void color_Source_sse(uint32_t* dest, int length, uint32_t color,
...
static void color_SourceOver_sse(uint32_t* dest, int length,
                                      uint32_t color,
                                     uint32_t const_alpha)
{
    int ialpha;
...
static void src_Source_sse(uint32_t* dest, int length, const uint32_t* src,
                           uint32_t const_alpha)
{
    int ialpha;
    if (const_alpha == 255) {
...
{
    updateColor(BlendMode::Src , color_Source_sse);
    updateColor(BlendMode::SrcOver , color_SourceOver_sse);

    updateSrc(BlendMode::Src , src_Source_sse);
}
